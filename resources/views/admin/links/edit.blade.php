                            ...
                            <form action="{{ route('admin.links.update', $link->id) }}" method="POST">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('link_full') is-invalid @enderror" id="link_full" name="link_full" placeholder="Введите сокращаемую ссылку" value="{{ $link->link_full }}">
                                    </div>
                                    @endif
                                    <div class="form-group">
                                        <label for="tiktok">Никнейм TikTok</label>
                                        <input type="text" class="form-control @error('tiktok') is-invalid @enderror" id="tiktok" name="tiktok" placeholder="Введите никнейм" value="{{ $link->tiktok }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="domain_id">Домен</label>
                                        <select class="form-control @error('domain_id') is-invalid @enderror" name="domain_id" id="domain_id">
                                            <option value="{{ $link->domain_id }}">{{ $link->domain->domain }}</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('country') is-invalid @enderror" name="country" id="country">
                                            <option value="{{ $link->country }}">{{ $link->country }}</option>
